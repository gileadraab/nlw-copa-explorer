const createGame = (player1, hour, player2) => {
  return `
    <li>
      <img src="./assets/icons-flags/icon-${player1}.svg" alt="Bandeira ${player1}" />
      <strong> ${hour} </strong>
      <img src="./assets/icons-flags/icon-${player2}.svg" alt="Bandeira ${player2}" />
    </li>
  `
}
...
const changeBGColor = (color) => {
  document.getElementById("body").classList = color
}
  ...
  return `
    <div id="app">
      <header id="header">
        ...
        <ul>
          <li onclick = changeBGColor("green")>green</li>
          <li onclick = changeBGColor("blue")>blue</li>
          <li onclick = changeBGColor("")>yellow</li>
        </ul>
      </header>
...
document.querySelector("#cards").innerHTML = 
  ...
  createCard('28/11', 'segunda', createGame('cameroon', '07:00', 'serbia') + createGame('south-korea', '10:00', "ghana") + createGame('brazil', '13:00', "switzerland") + createGame('portugal', '16:00', 'uruguay', 'germany')) +
  createCard('29/11', 'terça', createGame('ecuador', '12:00', 'senegal') + createGame('netherlands', '12:00', 'qatar') + createGame('iran', '16:00', 'usa') + createGame('wales', '16:00', 'england')) + 
